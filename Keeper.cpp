...
void Keeper::Set()
{
    ...
    {
        Base *ptr_bike = new Bike();
        array[countElement++] = ptr_bike;
        ptr_bike->Set();
    }
...
void Keeper::Load()
{
    ...
    if (loadB.is_open() and loadS.is_open() and loadC.is_open())
    {
        ...
        while (true)
        {
            ...
            Base *ptr_bike = new Bike(); // создаем объект - студент

            ptr_bike->Load(count, line);
            count++;
            ...
            this->array[countElement++] = ptr_bike; // добавляем в массив
        }
        ...
        while (true)
        {
            ...
            this->array[countElement++] = ptr_bus; // добавляем в массив
        }
